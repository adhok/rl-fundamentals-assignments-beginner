...
class MonteCarloAgent(BaseAgent):
    ...
    def _generate_episode(self, exploring_starts: bool = True) -> List[Tuple[Tuple[int, ...], int, float]]:
        ...
        while True:
            ...
            next_state, reward, terminated, truncated, info  = None  # TODO: Implement this assignment
            ...
            done: bool  = None  # TODO: Implement this assignment

            if done:
                break

            # HOMEWORK: the next state becomes the current state
            state  = None  # TODO: Implement this assignment

            # HOMEWORK: the next action is selected by the agent
            action  = None  # TODO: Implement this assignment
